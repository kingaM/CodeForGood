...
public class RMWidget extends View {
	...
	//CFC3B4
	private int defaultColor = Color.rgb(145, 125, 100); 	//default color of wedge pieces
	private int defaultAlpha = 140;  						//transparency of the colors, 255=Opague, 0=Transparent
	...
	private int outlineColor = Color.rgb(156, 87, 53);	//color of outline
	private int outlineAlpha = 70;							//transparency of outline
	...
	private int textColor = Color.rgb(77, 31, 8);  	//color to fill when something is selected
	...
	private int MinSize = scalePX(40);				//Radius of inner ring size
	...
	private int textSize = scalePX(16);				//TextSize
	...
	public RMWidget(Context context) {
		...
		this.yPosition = (getResources().getDisplayMetrics().heightPixels - 100)/2;
...
//    } 	
    ...
    {
       this.textSize = scalePX(TextSize + 3); 
